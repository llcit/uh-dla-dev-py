...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Record', fields ['identifier']
        db.create_unique(u'oaiharvests_record', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Record', fields ['identifier']
        db.delete_unique(u'oaiharvests_record', ['identifier'])
