...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'oaiharvests_metadataelement', 'element_data', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'oaiharvests.metadataelement': {
            ...
            'element_data': ('django.db.models.fields.TextField', [], {'default': "' '", 'blank': 'True'}),
